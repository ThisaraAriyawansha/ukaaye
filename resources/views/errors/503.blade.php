...
<head>
  ...
  <title>503 – Service Unavailable | Ukaaye Satellite Systems</title>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .err-maintenance-badge {
      display: inline-flex;
      align-items: center;
      gap: 8px;
      background: #fff8e1;
      border: 1.5px solid var(--theme-colour);
      color: #7a5c00;
      padding: 10px 22px;
      border-radius: 50px;
      font-size: 13px;
...
<body>
  ...
  <main class="err-main">
    <div class="err-card">
      <span class="err-icon"><i class="fa-solid fa-wrench"></i></span>
      <div class="err-code">5<span>0</span>3</div>
      <h1 class="err-title">Service Unavailable</h1>
      <div class="err-maintenance-badge">
        <i class="fa-solid fa-clock"></i> Scheduled Maintenance
      </div>
      <p class="err-desc">
