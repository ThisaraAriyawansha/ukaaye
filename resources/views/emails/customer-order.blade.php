...
<head>
    ...
    <style>
        ...
        .header { background: #ff5a5f; padding: 28px 30px; text-align: center; }
...
<div class="wrap">
    ...
    <div class="body">
        ...
        <p>We will notify you once your order is approved. If you have any questions, feel free to contact us.</p>
    </div>
    <div class="footer">
        &copy; {{ date('Y') }} Aromat Baby Food. All rights reserved.
    </div>
</div>
</body>
</html>
