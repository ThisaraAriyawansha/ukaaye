<style>
.tf-commitments .row > [class*="col-"]:not(:last-child) {
    margin-bottom: 24px;
}
</style>
<section class="tf-section tf-commitments">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="title-heading st-3 text-center">
                    <div class="sub-heading clr-pri-3 f-mulish">
                        ...
                        <span class="inner-sub st-1">Our Promises</span>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="77" height="30" viewBox="0 0 77 30">
                            <g>
                    ...
                    <h2 class="title clr-pri-2">Our Key Commitments</h2>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-12">
                <div class="wow fadeInUp animated" data-wow-delay="0.2ms" data-wow-duration="800ms"
                    style="background: #fff; border: 1px solid #e8e8e8; border-radius: 16px; box-shadow: 0 8px 30px rgba(0,0,0,0.06); padding: 36px 30px; height: 100%;">
                    <div style="width: 52px; height: 52px; border-radius: 12px; background: rgba(43,60,107,0.07); display: flex; align-items: center; justify-content: center; margin-bottom: 20px;">
                        <i class="fas fa-shield-alt" style="font-size: 20px; color: var(--primary-color2);"></i>
                    </div>
                    <h5 class="title clr-pri-2" style="margin-bottom: 10px;">Safety & Quality</h5>
                    <p class="f-mulish clr-pri-4" style="font-size: 14px; line-height: 1.75; margin: 0;">Maintain the highest food safety and quality assurance standards</p>
                </div>
            </div>

            <div class="col-lg-4 col-md-6 col-12">
                <div class="wow fadeInUp animated" data-wow-delay="0.3ms" data-wow-duration="800ms"
                    style="background: #fff; border: 1px solid #e8e8e8; border-radius: 16px; box-shadow: 0 8px 30px rgba(0,0,0,0.06); padding: 36px 30px; height: 100%;">
                    <div style="width: 52px; height: 52px; border-radius: 12px; background: rgba(255,102,102,0.08); display: flex; align-items: center; justify-content: center; margin-bottom: 20px;">
                        <i class="fas fa-rupee-sign" style="font-size: 20px; color: var(--primary-color3);"></i>
                    </div>
                    <h5 class="title clr-pri-2" style="margin-bottom: 10px;">Affordable Nutrition</h5>
                    <p class="f-mulish clr-pri-4" style="font-size: 14px; line-height: 1.75; margin: 0;">Ensure affordability while preserving nutritional integrity</p>
                </div>
            </div>

            <div class="col-lg-4 col-md-6 col-12">
                <div class="wow fadeInUp animated" data-wow-delay="0.4ms" data-wow-duration="800ms"
                    style="background: #fff; border: 1px solid #e8e8e8; border-radius: 16px; box-shadow: 0 8px 30px rgba(0,0,0,0.06); padding: 36px 30px; height: 100%;">
                    <div style="width: 52px; height: 52px; border-radius: 12px; background: rgba(26,185,255,0.08); display: flex; align-items: center; justify-content: center; margin-bottom: 20px;">
                        <i class="fas fa-map-marked-alt" style="font-size: 20px; color: var(--primary-color6);"></i>
                    </div>
                    <h5 class="title clr-pri-2" style="margin-bottom: 10px;">Nationwide Access</h5>
                    <p class="f-mulish clr-pri-4" style="font-size: 14px; line-height: 1.75; margin: 0;">Expand availability and accessibility across Sri Lanka</p>
                </div>
            </div>

            <div class="col-lg-4 col-md-6 col-12">
                <div class="wow fadeInUp animated" data-wow-delay="0.5ms" data-wow-duration="800ms"
                    style="background: #fff; border: 1px solid #e8e8e8; border-radius: 16px; box-shadow: 0 8px 30px rgba(0,0,0,0.06); padding: 36px 30px; height: 100%;">
                    <div style="width: 52px; height: 52px; border-radius: 12px; background: rgba(230,167,42,0.1); display: flex; align-items: center; justify-content: center; margin-bottom: 20px;">
                        <i class="fas fa-flask" style="font-size: 20px; color: var(--primary-color8);"></i>
                    </div>
                    <h5 class="title clr-pri-2" style="margin-bottom: 10px;">Continuous Innovation</h5>
                    <p class="f-mulish clr-pri-4" style="font-size: 14px; line-height: 1.75; margin: 0;">Continuously improve and innovate product formulations</p>
                </div>
            </div>

            <div class="col-lg-4 col-md-6 col-12">
                <div class="wow fadeInUp animated" data-wow-delay="0.6ms" data-wow-duration="800ms"
                    style="background: #fff; border: 1px solid #e8e8e8; border-radius: 16px; box-shadow: 0 8px 30px rgba(0,0,0,0.06); padding: 36px 30px; height: 100%;">
                    <div style="width: 52px; height: 52px; border-radius: 12px; background: rgba(178,80,254,0.08); display: flex; align-items: center; justify-content: center; margin-bottom: 20px;">
                        <i class="fas fa-hand-holding-heart" style="font-size: 20px; color: var(--primary-color5);"></i>
                    </div>
                    <h5 class="title clr-pri-2" style="margin-bottom: 10px;">Trust & Transparency</h5>
                    <p class="f-mulish clr-pri-4" style="font-size: 14px; line-height: 1.75; margin: 0;">Build long-term trust through transparency and reliability</p>
                </div>
            </div>
        </div>
    </div>
