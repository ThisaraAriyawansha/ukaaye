        ...
        <div class="row">
            <div class="col-12">
                <div class="sc-contact wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1200ms">
                    <div class="wrap">
                        <h2 class="title clr-pri-1">Ready To Nourish Your Little One?</h2>
                        <p class="sub clr-pri-1 f-mulish">Pure, organic nutrition made with love. Trusted by Sri Lankan parents.</p>
                    </div>
                    <div class="inner-sc-contact">
                        <div class="box-btn">
                            <a href="{{ route('products') }}" class="fl-btn st-9">
                                <span class="inner">Shop Now</span>
                                    ...
                                    <div class="inner-contact fx">
                                        ...
                                        <ul>
                                            ...
                                            <li class="clr-pri-1">+94 76 544 5356</li>
                                        </ul>
                                    </div>
                    </div>
                </div>
